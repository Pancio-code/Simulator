...
def run_simulation(alpha):
    ...
    nodes.append(create_node(env, 1, 0, Node.NodeType.WORKER, 1.0, 7, alpha, solar_panel_spec_by_node_id.get(1)))
    nodes.append(create_node(env, 2, 0, Node.NodeType.WORKER, 0.9, 8, alpha , solar_panel_spec_by_node_id.get(2)))
    nodes.append(create_node(env, 3, 0, Node.NodeType.WORKER, 0.6, 9, alpha, solar_panel_spec_by_node_id.get(3)))
